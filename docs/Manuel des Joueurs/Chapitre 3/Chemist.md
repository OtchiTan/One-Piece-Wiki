...
Au 1er niveau, vous connaissez deux capacités naturelles de votre choix dans la liste des sorts de chimiste du chapitre 8. Vous apprenez d'autres capacités naturelle de chimiste de votre choix à des niveaux plus élevés, comme indiqué dans la colonne des capacités naturelles connues de la table de chimiste.
